...
explicit ownership, and first-class workflow modeling. It targets ARM64 and
emphasizes predictable memory behavior without hidden aliasing.
...
- [Guide](guide/) -- Topic-focused guides:
  ...
  - [Generics](guide/generics.md) -- Type-parameterized functions and types
  - [Traits](guide/traits.md) -- Shared behavior, trait bounds, and properties
  - [Iterators and Pipe Operator](guide/iterators.md) -- Custom iterables, `Iterable<T>`, and `|>`
  - [Linear Types](guide/linear-types.md) -- Direct lifecycle-safe values and hosted workflows
