...
pub type StructDefField = model::StructDefField<String>;
pub type EnumDefVariant = model::EnumDefVariant<String>;
...
pub type FuncDecl = model::FuncDecl<String>;
pub type FuncDef = model::FuncDef<String>;
pub type FunctionSig = model::FunctionSig<String>;
pub type MethodBlock = model::MethodBlock<String>;
pub type MethodDef = model::MethodDef<String>;
