...
macro_rules! with_typecheck_variants {
    ($m:ident, $kind:expr) => {
        $m!(
            ...
            UnknownType,
            DependentArrayExtentNotAllowedHere,
            UnionNotAllowedHere,
            IterableNotAllowedHere,
            FixedLayoutRequiresStruct,
            FixedLayoutAlignRequiresFixedLayout,
            FixedLayoutFieldAlignRequiresFixedLayout,
            FixedLayoutUnknownFieldAttr,
            FixedLayoutCountFieldMissing,
            FixedLayoutCountFieldTypeMismatch,
            FixedLayoutCountedViewFieldMissingExtent,
            FixedLayoutInvalidAlign,
            ...
            ForeignViewElementMustBeFixedLayout,
            OpaqueIterableReturnMultipleWitnesses,
            PatternTypeMismatch,
            DeclTypeMismatch,
            ...
            RedundantNonZero,
            ForIterNotIterable,
            ForIterProtocolMissingIter,
            ForIterProtocolMissingNext,
            ForIterProtocolInvalidNextReturn,
            DivisionByZero,
            OverloadNoMatch,
            OverloadAmbiguous,
