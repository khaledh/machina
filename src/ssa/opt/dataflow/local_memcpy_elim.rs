...
) -> HashSet<crate::ssa::model::ir::LocalId> {
...
fn build_replacement_map(
    candidates: &[(
        usize,
        usize,
        crate::ssa::model::ir::LocalId,
        Option<crate::ssa::model::ir::LocalId>,
        ValueId,
    )],
) -> HashMap<crate::ssa::model::ir::LocalId, ValueId> {
...
fn resolve_replacement(
    local: crate::ssa::model::ir::LocalId,
    replacements: &HashMap<crate::ssa::model::ir::LocalId, ValueId>,
    func: &Function,
    def_inst: &HashMap<ValueId, (usize, usize)>,
) -> ValueId {
