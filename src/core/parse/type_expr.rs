...
impl<'a> Parser<'a> {
    ...
    fn parse_type_term(&mut self) -> Result<TypeExpr, ParseError> {
        ...
        typ = self.parse_nullable_low_level_type_postfix(typ)?;
    ...
    fn parse_nullable_low_level_type_postfix(
        &mut self,
        mut typ: TypeExpr,
    ...
    fn parse_named_type(&mut self) -> Result<TypeExpr, ParseError> {
        ...
        match &self.curr_token.kind {
            ...
            _ => self.err_here(PEK::ExpectedType(self.curr_token.clone())),
        }
    }
    ...
    fn parse_refinement(&mut self) -> Result<RefinementKind, ParseError> {
        match &self.curr_token.kind {
            ...
            _ => self.err_here(PEK::ExpectedRefinement(self.curr_token.clone())),
        }
    }
}
