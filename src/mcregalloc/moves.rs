...
pub struct FnMoveList {
    ...
    edge_moves: HashMap<BlockId, Vec<Move>>,
...
impl FnMoveList {
    ...
    pub fn add_edge_move(&mut self, from_block_id: BlockId, from: Location, to: Location) {
        self.edge_moves
            .entry(from_block_id)
            .or_default()
            .push(Move { from, to });
    ...
    pub fn get_edge_moves(&self, from_block_id: BlockId) -> Option<&Vec<Move>> {
